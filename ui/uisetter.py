...
class Ui_MainWindow_2(object):
    def setupUi(self, MainWindow:QtWidgets.QMainWindow):
        ...
        self.gridLayout.addWidget(self.pushButton_left_load, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_right_load, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_previous_diff, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_next_diff, 3, 3, 1, 1)
        ...
        self.pushButton_right_load.clicked.connect(self.plainTextEdit_master.uploadfile)
        ...
        self.pushButton_left_load.clicked.connect(self.plainTextEdit_slave.uploadfile)
    ...
    def retranslateUi(self, MainWindow:QtWidgets.QMainWindow):
        ...
        MainWindow.setWindowTitle(self._translate("MainWindow", "BaiNvCompare V2.0.2"))
        self.label_left_mode.setText(self._translate("MainWindow", "编辑模式"))
        self.label_right_mode.setText(self._translate("MainWindow", "编辑模式"))
        self.pushButton_left_load.setText(self._translate("MainWindow", "导入"))
        self.pushButton_left_save.setText(self._translate("MainWindow", "保存"))
        self.pushButton_right_load.setText(self._translate("MainWindow", "导入"))
        self.pushButton_right_save.setText(self._translate("MainWindow", "保存"))
        self.pushButton_previous_diff.setText(self._translate("MainWindow", "上一处原始差异"))
        self.pushButton_next_diff.setText(self._translate("MainWindow", "下一处原始差异"))
        self.pushButton_refresh_diff.setText(self._translate("MainWindow", "刷新差异 (F5)"))
